...
function upperDirectiveTransformer(schema, directiveName) {
    ...
    return (0, utils_1.mapSchema)(schema, (_a = {},
        _a[utils_1.MapperKind.OBJECT_FIELD] = function (fieldConfig) {
            var _a;
            var upperDirective = (_a = (0, utils_1.getDirective)(schema, fieldConfig, directiveName)) === null || _a === void 0 ? void 0 : _a[0];
            if (upperDirective) {
                var _b = fieldConfig.resolve, resolve_1 = _b === void 0 ? graphql_1.defaultFieldResolver : _b;
                ...
                fieldConfig.resolve = function (source, args, context, info) {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, resolve_1(source, args, context, info)];
                                case 1:
                                    result = _a.sent();
